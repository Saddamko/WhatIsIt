...
//    private float mSensorValue;
 ...
 //       speak("Привет" );
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        Toast.makeText(MainActivity.this, "Начало распознавания", Toast.LENGTH_SHORT).show();
                        break;
                    case MotionEvent.ACTION_UP:
                        stopRecognition();
                        Toast.makeText(MainActivity.this, "Окончание  распознавания", Toast.LENGTH_SHORT).show();
                        break;
                }
                return true;
            }
    ...
    private void startStopRecognition() {
        if (mRecognizer == null) {
            Toast.makeText(MainActivity.this, "Не инициализирован mRecognizer", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (KWS_SEARCH.equals(mRecognizer.getSearchName())) {
            ...
            stopRecognition();
            Toast.makeText(MainActivity.this, "Конец распознавания", Toast.LENGTH_SHORT).show();
        }
    }
